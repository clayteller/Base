<?php
/**
 * Widget API: Base_Widget_Contact_Info class
 *
 * @package Base
 * @subpackage Widgets
 * @since 1.0.1
...
/**
 * Class used to implement a Base Contact Info widget.
 */
class Base_Widget_Contact_Info extends WP_Widget {
	/**
	 * Set up a new Base Contact Info widget instance.
	 */
